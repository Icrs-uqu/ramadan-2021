...
window.addEventListener('load', DrawPlaceholder(img,ctx,"#756134",'p3.jpg',370,400));
...
window.addEventListener('load', DrawPlaceholder(img1,ctx1,"#756134",'p2.jpg',310,360));
...
window.addEventListener('load', DrawPlaceholder(img2,ctx2,"#756134",'p1.jpg',370,380));
...
img3.crossOrigin="anonymous";
    ...
    window.addEventListener('load', DrawPlaceholder(img3,ctx3,"#756134",'p4.jpg',500,260));
...
window.addEventListener('load', DrawPlaceholder(img4,ctx4,"#AC8F4B",'p5.jpg',370,300));
...
window.addEventListener('load', DrawPlaceholder(img5,ctx5,"#64C4C8",'p6.jpg',370,330));
